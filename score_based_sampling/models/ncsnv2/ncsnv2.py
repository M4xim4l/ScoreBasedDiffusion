...
class NCSNv2(nn.Module):
    def __init__(self, in_channels, img_size, sigmas, num_classes=10, ngf=128, nonlinearity='elu', norm='InstanceNorm++'):
        super().__init__()
...
def get_MNIST_NCSNv2(sigmas):
    return NCSNv2(1, 28, sigmas, num_classes=len(sigmas))

def get_CIFAR_NCSNv2(sigmas):
    return NCSNv2(3, 32, sigmas, num_classes=len(sigmas))
